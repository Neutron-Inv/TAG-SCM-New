...
class IndustryRepository implements IndustryRepositoryInterface
{
    ...
    public function update(array $data, $industry_id)
    {
        $update = $this->model->findOrFail($industry_id);
        return $update->update($data);
    }
    // remove record from the database
    public function delete($industry_id)
    {
        return $this->model->destroy($industry_id);
    }
    // show the record with the industry_id
    public function show($industry_id)
    {
        return $this->model->findOrFail($industry_id);
    }
