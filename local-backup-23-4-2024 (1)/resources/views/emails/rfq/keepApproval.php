                        ...
                        <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 632px;margin: 0 auto;">
                            <tbody>
                                <tr>
                                    ...
                                    border-radius: 4px 4px 0px 0px;padding-left: 16px;padding-right: 16px;padding-bottom: 10px;">
            ...
            <tbody>
                <tr>
                    <td class="o_bg-light o_px-xs" align="center" data-bgcolor="Bg Light" style="background-color: #dbe5ea;padding-left: 8px;padding-right: 8px;">
                        ...
                        <table class="o_block" border="0" cellspacing="0" cellpadding="0" width="80%" style="max-width:100.0pt; margin-left:-.15pt; border-collapse:collapse; background-color: #ffffff;">
                            <tbody>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="o_bg-white o_px o_pb-md" align="center" data-bgcolor="Bg White" style="background-color: #ffffff;padding-left: 16px;padding-right: 16px;padding-bottom: 24px;">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="o_btn o_bg-primary o_br o_heading o_text" align="center" data-bgcolor="Bg Primary" data-size="Text Default" data-min="12" data-max="20"
                                                                                ...
                                                                                <?php $url = 'https://scm.enabledjobs.com/dashboard/request-for-quotation/approve-breakdown/'.$rfq->refrence_no; ?>
                                                                            ...
                                                                            <?php $url2 = 'https://scm.enabledjobs.com/dashboard/request-for-quotation/decline-breakdown/'.$rfq->refrence_no; ?>
                                                        ...
                                                        <div class="o_col_i" style="display: inline-block;vertical-align: top;" align="left">
                                                            <div style="font-size: 24px; line-height: 24px; height: 24px;">&nbsp; </div>
                                                            <div class="o_px-xs" style="padding-left: 8px;padding-right: 8px;">
                                                                <table align="center" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                                                    <tbody>
                                                                        <tr>
                                                                            <p style="font-size: 8.5pt;font-family: Arial,sans-serif; color: #1F497D;">Best Regards,<br> {{ Auth::user()->first_name . ' '. strtoupper(Auth::user()->last_name) }}, <br> SCM Specialist II <br>
                                    ...
                                    <td class="o_bg-light o_px-xs o_pb-lg o_xs-pb-xs" align="center" data-bgcolor="Bg Light" style="background-color: #dbe5ea;padding-left: 8px;padding-right: 8px;padding-bottom: 32px;">
                                        ...
                                        <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 632px;margin: 0 auto;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="o_re o_bg-dark o_px o_pb-lg" align="center" data-bgcolor="Bg Dark" style="font-size: 0;vertical-align: top;background-color: white;padding-left: 16px;padding-right: 16px;padding-bottom: 32px;">
                                                        ...
                                                        <div class="o_col o_col-4" style="display: inline-block;vertical-align: top;width: 100%;max-width: 400px;">
                                                            ...
                                                            <div class="o_px-xs o_sans o_text-xs o_text-light o_left o_xs-center" data-color="Light" data-size="Text XS" data-min="10" data-max="18" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;color: #82899a;text-align: left;padding-left: 8px;padding-right: 8px;">
                                                                <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 8px; color: black">©Enabled Business Solution. All rights reserved.</p>
