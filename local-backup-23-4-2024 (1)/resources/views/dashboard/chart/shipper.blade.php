    ...
    <div class="main-container">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('rfq.chart.shipper') }}"> RFQ Shipper Charts</a></li>
                    ...
                    <div class="row gutters">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"><?php
                            $arrChartConfig = array(
                                "chart" => array(
                                    "caption" => strtoupper("SCM Shippers RFQ Chart"),
                                    ...
                                    "theme" =>"gammel",
                                    "exportEnabled" =>  "1",
                                    "exportFileName" => strtoupper("Shippers RFQ Chart"),
                                    "legendPosition" => "LEFT",
                                    "showLegend" => "1",
                            ...
                            foreach ($shipper as $shippers){
                                array_push($arrLabelValueData, array(
                                    "label" => strtoupper($shippers->shipper_name), "value" => shipperChart($shippers->shipper_id)
                                ));
                            }
