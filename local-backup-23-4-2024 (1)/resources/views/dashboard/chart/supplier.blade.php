    ...
    <div class="main-container">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('rfq.chart.supplier') }}"> RFQ Supplier Charts</a></li>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="row gutters">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"><?php
                            ...
                            $Chart = new FusionCharts("pie2d", "BranchCustomer", "100%", 600, "chart-container", "json", $jsonEncodedData);
                            $Chart->render();?>
                           <div class="card">
                                <div class="card-body" id="chart-container" style="position: relative; height: 630px;"></div>
                            </div>
