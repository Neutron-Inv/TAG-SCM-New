    ...
    <div class="main-container">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('rfq.chart.client') }}">Client RFQ Charts</a></li>
                    ...
                    <div class="row gutters">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12"><?php
                            $arrChartConfig = array(
                                "chart" => array(
                                    "caption" => strtoupper("SCM Clients RFQ Chart"),
                                    "subCaption" => "Powered by Enabled Solution",
                                    "xAxisName" => strtoupper("Client Name"),
                            ...
                            foreach ($client as $clients){
                                array_push($arrLabelValueData, array(
                                    "label" => strtoupper($clients->client_name), "value" => clientsChart($clients->client_id)
                                ));
                            }
