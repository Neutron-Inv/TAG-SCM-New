    ...
    <div class="main-container">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('unit.index') }}">UOM</a></li>

                <li class="breadcrumb-item">List of UOM</li>
            </ol>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-header">
								<div class="card-title">Please fill the below form to add uom details </div>
							</div>
                            <form action="{{ route('unit.save') }}" class="" method="POST">
                                {{ csrf_field() }}
                                ...
                                <div class="row gutters">
                                    <div class="col-xl-9 col-lg-9 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="unit_name" required placeholder="Enter Unit Name" type="text" value="{{old('unit_name')}}"
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <button class="btn btn-primary btn-block" type="submit" title="Click the button to add unit">Add Unit of Measurement</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
