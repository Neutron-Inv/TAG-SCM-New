                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('inventory.user.save') }}" class="" method="POST">
                                {{ csrf_field() }}
                                ...
                                <div class="row gutters">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12" align="center">
                                        <div class="form-group">
                                            <button class="btn btn-primary " type="submit" title="Click the button to add new user details"
                                             style="margin-top: 20px">Add A New Warehouse User</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            @else
                                <div class="table-container">
                                    <h5 class="table-title">List of All Ware House Users </h5>
