    ...
    <div class="main-container">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('report.edit',$repo->report_id) }}"> Edit Client Report</a></li>
                <li class="breadcrumb-item"><a href="{{ route('report.index',$client->client_id) }}"> Client Report</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-header">
								<div class="card-title">Please fill the below form to update the client report </div>
							</div>
                            <form action="{{ route('report.update',$repo->report_id) }}" class="" method="POST">
                                {{ csrf_field() }}
                                ...
                                <div class="row gutters">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="card m-0">
                                            ...
                                            <textarea class="summernote" name="note" required placeholder="Please enter RFQ Note">{{$repo->note ?? '' }} </textarea>
                                            @if ($errors->has('note'))
                                    ...
                                    <input type="hidden" name="report_id" value="{{ $repo->report_id }}">

                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" align="right">
                                        <div class="form-group">
                                            <button class="btn btn-primary" type="submit" title="Update the client report">Update Client Report</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
