    ...
    <div class="invoice-container" id="printableArea" style="background-color: white !important;font-family: Calibri, sans-serif;border-box;">
        ...
        <div class="invoice-header" style="font-family: Calibri, sans-serif;border-box;padding: .5rem 1.5rem;">
            ...
            <div class="row gutters" style="border-box;display: flex;-ms-flex-wrap: wrap;flex-wrap: wrap;margin-right: -8px;margin-left: -8px;">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8" style="margin-left:480px ;" align="">

                    @foreach ($sup as $sups)
                        <p style="font-size: 11.5pt;font-family: Calibri,sans-serif;border-box;margin-top: 0;margin-bottom: 2px;orphans: 3;widows: 3;
                        line-height: 180%;font-weight: 450; margin-left:450px;">
                            {{ $sups->vendor_name ?? ' Supplier Name ' }} 
                        </p>
                    @endforeach
                    
                    <p style="margin-left:450px; font-size: 11.0pt;font-family: Calibri,sans-serif;border-box;margin-top: 0;margin-bottom: 2px;orphans: 3;widows: 3;line-height: 180%;font-weight: 400;">
                    ...
                    <br style="border-box;">
                    <p style="margin-left:510px; font-size: 10.9pt;font-family: Calibri,sans-serif;border-box;margin-top: -13;margin-bottom: 2px;orphans: 3;widows: 3;line-height: 190%;
            ...
            <div class="row gutters" >
                ...
                <div class="col-lg-12 col-md-12 col-sm-12" style="padding-left: 15px; margin-left: 33px; font-size: 10.9pt;  margin-top:-200px;">
                        ...
                        <table class="table" style="font-size: 10.9pt;font-family: Calibri, sans-serif;border-box;border-collapse: collapse!important;width: 890px;margin-bottom: 1rem;color: #000000;background: #ffffff;
                            ...
                            <thead class="text-white" style="font-size: 10.9pt;font-family: Calibri, sans-serif;border-box;display: table-header-group;background: #6610f2;color: #000000 !important;">
                                <tr style="border: 2mm ridge black; border-bottom: ridge;border-bottom-color: #dd3939;font-size: 10.9pt;font-family: Calibri, sans-serif;border-box;page-break-inside: avoid;">
                                    ...
                                    <th class="" style="padding-top: 3px;width: 690px;color: black;background-color: #F0F3F4 !important;text-align: left;
                                    ...
                                    <th class="" style="text-color:#000000; padding-top: 3px;text-align: right;color: black;background-color: #F0F3F4 !important;font-family: Calibri, sans-serif;font-size: 10.9pt;border-box;
                            ...
                            <tbody style="font-size: 10.9pt;font-family: Calibri, sans-serif;border-box;">
                                ...
                                @foreach ($line_items as $items)
                                    ...
                                    <tr style="font-size: 9.0pt; font-family: Calibri, sans-serif; orphans: 3;widows: 3;line-height: 180%;font-weight: 400;">
                                        ...
                                        <td style="orphans: 3;widows: 3;line-height: 180%;font-weight: 400; padding-top: 2px; text-align: center; font-size: 9.0pt; font-family: Calibri, sans-serif;">{{$items->quantity ?? 0}} </td>
                                        ...
                                        <td style="orphans: 3;widows: 3;line-height: 180%;font-weight: 400; padding-top: 2px; font-size: 9.0pt; font-family: Calibri, sans-serif;" align="right"> {{ number_format($items->unit_cost * $items->quantity, 2) }} </td>
                                ...
                                <tr style="font-size: 10.9pt; font-family: Calibri, sans-serif;">
                                    ...
                                    <td colspan="2" style="background-color:white; font-size: 10.9pt font-family: Calibri, sans-serif; margin-left: 100px;" align="left">
                                        ...
                                        <p style="text-align: right; width: 100%; font-size: 10.9pt; font-family: Calibri, sans-serif;">
                                            <b style=""> Total </b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <strong ><span style="text-align: right;">&nbsp;&nbsp;{{ number_format($sumTotalQuote + $ship + $fri, 2) ?? 0 }} </strong>
                                        </p>
                                        
                                        <p style="border-bottom: double; border-bottom-color: #000000; border-top-color: #000000; width: 100%; margin-bottom:;"></p>

                                        <p style="border-bottom: double; border-bottom-color: #000000; border-top-color: #000000; width: 100%; margin-bottom:;"></p><br>
                                    </td>
                                </tr>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <b> 1. Delivery: </b>  Not later than 10 Weeks CIF Lagos, after receipt of Purchase Order.<br>
                        <b> 2. Delivery Locations:</b> TAG Energy VRC, Port Harcourt <br>
                        <b>3.  Payment Terms: <b>20% payable with order, balance is due when goods are ready for shipment.
                        <br>
                        <b>
                        4. Contact:  </b>
                        @foreach (emps($rfq->employee_id) as $emp)
                            {{ $emp->full_name ?? ' ' }} , +234 1 342 8420, sales@tagenergygroup.net
                        @endforeach 
                        <br><br>
                    ...
                    <div class="row gutters" style="border-box;display: flex;-ms-flex-wrap: wrap;flex-wrap: wrap;margin-right: -8px;">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6" style="margin-top:">
                            <b> Best Regards  <br>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6" style="margin-left:780px ;" align="">
                            <b style="text-align:right;"> Accepted By:  <br>
                                <br><br><br><br><br>
