...
<html>
    ...
    <body marginwidth="0" marginheight="0" style="margin-top: 0; margin-bottom: 0; padding-top: 0; padding-bottom: 0; width: 100%; background-color: #dbe5ea;" offset="0" topmargin="0" leftmargin="0">
        ...
        <table data-module="header-primary-link" data-visible="false" data-thumb="https://scm.enabledjobs.com/admin/img/TAG%20Energy%20Logo.png"
                ...
                <tr>
                    <td class="o_bg-light o_px-xs o_pt-lg o_xs-pt-xs" align="center" data-bgcolor="Bg Light" style="background-color: #dbe5ea;padding-left: 8px;padding-right: 8px;padding-top: 32px;">
                        <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 632px;margin: 0 auto;">
                            <tbody>
                                <tr>
                                    <td class="o_re o_bg-primary o_px o_pb-md o_br-t" align="center" data-bgcolor="Bg Primary" style="font-size: 0;vertical-align: top;background-color: #ffffff;
                                        ...
                                        <div class="o_col o_col-2" style="display: inline-block;vertical-align: top;width: 100%;max-width: 200px;">
                                            ...
                                            <div class="o_px-xs o_sans o_text o_left o_xs-center" data-size="Text Default" data-min="12" data-max="20" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;
                                                ...
                                                <p style="margin-top: 0px;margin-bottom: 0px;"><a class="o_text-white" href="https://scm.enabledjobs.com/dashboard" data-color="White" style="text-decoration: none;outline: none;color: #ffffff;">
                                                    <img src="https://scm.enabledjobs.com/admin/img/TAG%20Energy%20Logo.png" width="46" height="26" alt="SCM"
                                                    style="max-width: 136px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;" data-crop="false"></a>
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="left" data-bgcolor="Bg White" data-color="Secondary" data-size="Text Default" data-min="12"
                                        ...
                                        <p style="color: #203864; font-size: 10pt;
                                            font-family: Calibri, sans-serif;">  Good Day {{ $contact->first_name . ' '. $contact->last_name ?? '' }},
                                        </p>
                                        <p style="color:#203864; font-size: 10pt;
                                        font-family: Calibri, sans-serif;">
                                            This is to acknowledge receipt of your PO {{ $po->po_number }}. <br><br>
                                            Thank you very much for this opportunity, we promise to exceed your expectations for delivery performance. <br>
                                        <p style="font-size: 7.5pt;font-family: Arial,sans-serif; color: #1F497D;"> Best Regards,  </p><br>
                                        <p style="font-size: 7.5pt;font-family: Arial,sans-serif; color: #1F497D;"> {{ Auth::user()->first_name . ' '. strtoupper(Auth::user()->last_name) }}, <br> SCM Specialist II <br>
