                                ...
                                <tr>
                                    <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="left" data-bgcolor="Bg White" data-color="Secondary" data-size="Text Default" data-min="12"
                                        ...
                                        <p style="color: #203864; font-size: 9.0pt;
                                            font-family: Calibri, sans-serif; margin-top:-20px;">

                                            Dear {{ $vendor->contact_name }}, <br>
                                            I hope this mail finds you well. <br>
                                            Please acknowledge receipt (sign, stamp and revert with a scanned copy) of our attached Purchase Order with <br> regards to your quotation
                                            {{ $rfq->refrence_no ?? '' }}  (see below correspondences) for the supply of {{ $rfq->product ?? '' }}. <br>
                                            <b>We will appreciate if tentative ETA to {{ $po->port_of_discharge ?? '' }} Port can be expedited to 10 weeks from confirmed order. </b>
                                            Kindly let us know if you have any questions and/or require clarifications with regards to this. <br>
