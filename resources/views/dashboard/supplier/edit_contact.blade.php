<?php $title = 'Edit Supplier Contact'; ?>
@extends('layouts.app')
    ...
    <div class="main-container">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('vcontact.edit',$conc->contact_id) }}">Edit Supplier Contact</a></li>
                <li class="breadcrumb-item "><a href="{{ route('vendor.index') }}"> Suppliers</a></li>
                @if (auth()->user()->hasRole('SuperAdmin'))
                    <li class="breadcrumb-item"><a href="{{ route('vcontact.index',$ven->vendor_id)}}">View Supplier Contacts</a></li>

                @else

                @endif
                <li class="breadcrumb-item">Edit a Supplier Contact</li>
            </ol>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-header">
								<div class="card-title">Please fill the below form to update the contact for {{ $ven->vendor_name }}. </div>
							</div>
                            <form action="{{ route('vcontact.update',$conc->contact_id) }}" class="" method="POST">
                                {{ csrf_field() }}
                                <div class="row gutters">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="first_name" id="inputName" value="{{ $conc->first_name ?? old('first_name')  }}" required placeholder="Enter First Name" type="text"
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label for="lastName">Last Name</label><div class="input-group">
                                                ...
                                                <input class="form-control" name="last_name" value="{{ $conc->last_name ?? old('last_name') }}" id="lastName" required placeholder="Enter Last Name" type="text"
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                value="{{ $conc->job_title ?? old('job_title') }}"
                                                aria-describedby="basic-addon1">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="office_tel" minlength="5" required placeholder="Enter Office Phone" type="number" value="{{ $conc->office_tel ?? old('office_tel') }}"
                                                aria-describedby="basic-addon1">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="mobile_tel" placeholder="Enter Phone Number" type="number" value="{{ $conc->mobile_tel ?? old('mobile_tel') }}"
                                                aria-describedby="basic-addon1">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="email" required placeholder="Enter Email" type="email" value="{{ $conc->email ?? old('email') }}"
                                                aria-describedby="basic-addon1">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="email_other" placeholder="Enter Email" type="email" value="{{ $conc->email_other ?? old('other_email') }}"
                                                aria-describedby="basic-addon1">
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="country" class="form-control selectpicker" data-live-search="true" name="country" onchange="fetchStates(this)">
                                            <option value="{{ $conc->country_code ?? old('country') }}">{{ $conc->country_code ?? old('country') }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="state" class="form-control selectpicker" data-live-search="true" name="state" onchange="fetchCities(this)">
                                            <option value="{{ $conc->state ?? old('state')}}">{{ $conc->state ?? old('state')}}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="city" class="form-control selectpicker" name="city">
                                            <option value="{{ $conc->city ?? old('city') }}">{{ $conc->city ?? old('city') }}</option>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="nameOnCard" name="address" required placeholder="Enter address">{{ $conc->address ?? old('address') }}</textarea>
                                            </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" align="right">
                                        <div class="form-group">
                                            <button class="btn btn-primary" type="submit" title="Click the button to update the client contact">Update The Contact Details</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            @else
                                <div class="table-container">
                                    <h5 class="table-title">List of all Supplier Contacts</h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $num }}
                                                            ...
                                                            @if (Gate::allows('SuperAdmin', auth()->user()))
                                                                <a href="{{ route('vcontact.delete',$contacts->contact_id) }}" title="Delete The Client Contact" class="" onclick="return(confirmToDelete());">
                                                                    <i class="icon-delete" style="color:red"></i>
                                                                </a> 
                                                            @endif
                                                        </td>
                                                        <td>{{ $contacts->vendor->vendor_name ?? '' }}</td>
