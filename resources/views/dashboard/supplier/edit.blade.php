                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="contact_email" readonly placeholder="Enter Email" type="email" value="{{ $ven->contact_email ?? '' }}"
                                                aria-describedby="basic-addon1">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control selectpicker" data-live-search="true" required name="country_code">
                                                    <option data-tokens="{{ $ven->country_code ?? '' }}" value="{{ $ven->country_code ?? '' }}">{{ $ven->country_code ?? '' }}</option>
                                                    <option value=""> </option>
