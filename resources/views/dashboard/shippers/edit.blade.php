    ...
    <div class="main-container">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('shipper.edit',$ship->shipper_id) }}">Edit Shipper</a></li>
                <li class="breadcrumb-item"><a href="{{ route('shipper.index') }}">Add Shipper</a></li>

                {{-- <li class="breadcrumb-item"><a href="{{ route('shipper.restore') }}">Bin</a></li> --}}
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-header">
                                <div class="card-title">Please fill the below form to update the shipper details </div>
                            </div>
                            <form action="{{ route('shipper.update',$ship->shipper_id) }}" class="" method="POST">
                                {{ csrf_field() }}
                                ...
                                <div class="row gutters">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control selectpicker" data-live-search="true" required name="company_id">
                                                    @if (Gate::allows('SuperAdmin', auth()->user()))
                                                        <option data-tokens="{{ $ship->company_id }}" value="{{ $ship->company_id }}">
                                                            {{ $ship->company->company_name }}
                                                        </option>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="contact_name" required placeholder="Enter Name" type="text" value="{{ $ship->contact_name ?? ''}}"
                                                aria-describedby="basic-addon1">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="contact_phone" required placeholder="Enter Phone" type="text" value="{{ $ship->contact_phone ?? ''}}"
                                                aria-describedby="basic-addon1">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="contact_email" readonly placeholder="Enter Email" type="email" value="{{ $ship->contact_email ?? ''}}"
                                                aria-describedby="basic-addon1">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control selectpicker" data-live-search="true" required name="country_code">
                                                    <option data-tokens="{{ $ship->country_code ?? ''}}" value="{{ $ship->country_code ?? ''}}">{{ $ship->country_code ?? ''}}</option>
                                                    <option value=""></option>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="nameOnCard" name="address" required placeholder="Enter address">{{ $ship->address ?? ''}}</textarea>
                                            </div>
                                    ...
                                    <input type="hidden" name="shipper_id" value="{{ $ship->shipper_id ?? ''}}">
                                    <div class="col-xl-12 col-lg-12 col-md-6 col-sm-6 col-12" align="right">
                                        <div class="form-group">
                                            <button class="btn btn-primary" type="submit" title="Click the button to update Shipper">Update Shipper Details</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            @else
                                <div class="table-container">
                                    <h5 class="table-title">List of all Shippers</h5>
                                                ...
                                                @foreach ($shipper as $shippers)
                                                    <tr>
                                                        ...
                                                        <td>{{ $num }}
                                                            ...
                                                            <a href="{{ route('shipper.edit',$shippers->shipper_id) }}" title="Edit The SHipper Details" class="" onclick="return(confirmToEdit());">
