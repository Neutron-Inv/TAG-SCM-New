        ...
        <div class="invoice-container" id="printableArea" style="background-color: white !important;font-family: Calibri, sans-serif;border-box;">
            ...
            <div class="invoice-header" style="font-family: Calibri, sans-serif;border-box;padding: .5rem 1.5rem;">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4" style="border-box;position: relative;width: 100%;padding-right: 15px;padding-left: 15px;
                        ...
                        <div class="invoice-logo" style="border-box;font-size: 1.2rem;color: #074b9c;font-weight: 700;">
                            ...
                            @if(Auth::user()->hasRole('SuperAdmin'))
                                @foreach (getLogo($rfq->company_id) as $item)
                                    ...
                                    <img src="{{$log}}" style="width: 101px; margin-left: -5px;" alt="{{$log}}">
                                @endforeach
                            @elseif(Auth::user()->hasRole('Admin'))
                                @foreach (getLogo($rfq->company_id) as $item)
                                    @php $log = 'https://scm.enabledjobs.com/company-logo'.'/'.$rfq->company_id.'/'.$item->company_logo; @endphp
                                    <img src="{{$log}}" style="width: 101px; margin-left: -5px;" alt="">
                                @endforeach
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12" style="margin-left: -12px;font-family: Calibri,sans-serif;margin-top: -10px;border-box;position: relative;width: 100%;padding-right: 15px;padding-left: 15px;-ms-flex: 0 0 100%;flex: 0 0 100%;max-width: 100%;">
                            ...
                            <h6 style="font-size: 8.9pt;margin-top: -20px;border-box;margin-bottom: .2rem;font-weight: 700;orphans: 3;widows: 3;line-height: 180%;font-weight: 400;">
                                <b>@foreach (clis($rfq->client_id) as $cli)

                                        {{ $cli->client_name .' Rfx: '. $rfq->rfq_number ?? ' Rfx: '. $rfq->rfq_number }}
                                    @endforeach 
                				</b>
                            </h6><br style="border-box;">
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-8 col-sm-8" style="margin-left:440px ;" align="right">
                        ...
                        <img src="https://scm.enabledjobs.com/img/price.png" style="width: 260px;height: 130px;margin-top: 14px;border-box;vertical-align: middle;border-style: none;page-break-inside: avoid;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;" alt="Certification">
                        <br style="border-box;">
                        <p style="font-size: 8.9pt;font-family: Calibri,sans-serif;border-box;margin-top: -13;margin-bottom: 2px;orphans: 3;widows: 3;line-height: 180%;
                ...
                <div class="row gutters" >
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12" style="margin-left: 6px; font-size: 9.9pt;  margin-top:-230px;">
                        ...
                        <div class="table-responsive" style="font-size: 9.9pt;font-family: Calibri, sans-serif;border-box;display: block;width: 150%;overflow-x: auto;-webkit-overflow-scrolling: touch;">
                            ...
                            <table class="table" style="font-size: 9.9pt;font-family: Calibri, sans-serif;border-box;border-collapse: collapse!important;width: 1150px;margin-bottom: 1rem;color: #000000;background: #ffffff;
                                ...
                                <thead class="text-white" style="font-size: 9.9pt;font-family: Calibri, sans-serif;border-box;display: table-header-group;background: #6610f2;color: #000000 !important;">
                                    <tr style="border: 2mm ridge black; border-bottom: ridge;border-bottom-color: #dd3939;font-size: 9.9pt;font-family: Calibri, sans-serif;border-box;page-break-inside: avoid;">
                                        ...
                                        <th class="" style="padding-top: 3px;width: 1000px;color: black;background-color: #F0F3F4 !important;text-align: left;
                                    ...
                                    @foreach ($line_items as $items)
                                        ...
                                        <tr style="font-size: 9.0pt; font-family: Calibri, sans-serif; orphans: 3;widows: 3;line-height: 180%;font-weight: 400;">
                                            ...
                                            <td style="padding-top: 2px;">
                                                ...
                                                <p style="font-size: 9.0pt; line-height: 180%;font-weight: 400; text-align: justify;">
                                            ...
                                            <td style="orphans: 3;widows: 3;line-height: 180%;font-weight: 400; padding-top: 2px; font-size: 9.0pt; font-family: Calibri, sans-serif;" align="center"><b> {{number_format($unit_cost + $unitMargin, 2) ?? 0}}</b> </td>
                                    ...
                                    <tr style="font-size: 9.9pt; font-family: Calibri, sans-serif;">
                                        ...
                                        <td colspan="3" style="background-color:white; font-size: 9.0pt; font-family: Calibri, sans-serif; margin-left: 100px;" align="left">
                                            <p style="border-bottom: ridge; border-bottom-color: #000000; border-top: ridge;
                                                ...
                                                <strong style="padding-left:"> Sub total &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            ...
                                            <p style="border-bottom: double; border-bottom-color: #000000; border-top-color: #000000; width: 105%; margin-bottom:105px;"></p><br>
                                        </td>
                                    </tr>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            ...
                            <p style="font-size: 10.0pt; font-family: Calibri, sans-serif; margin-left:-5px; margin-top:-30px;"><b style="color:red"><b>ESTIMATED PACKAGED WEIGHT: {{ $rfq->estimated_package_weight}} <br>
                            ...
                            <p style="font-size: 11.0pt; font-family: Calibri; margin-left:-5px"><b style="color:red">Notes to Pricing: </b><br>
                            ...
                            <p style="margin-top: -35px; margin-left:0px; color:black;">
                            ...
                            <p style="margin-top: -8px; margin-left:0px">
                                <b>
