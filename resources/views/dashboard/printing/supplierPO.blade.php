            ...
            <div class="invoice-header" style="padding: .5rem 1.5rem;">
                ...
                <div class="row gutters" style="position: relative; margin-bottom:20px;">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 offset-lg-4 offset-md-4 offset-sm-4" style="position: absolute; top: 0; right: 0; text-align: right;">
                        <p style="font-size:5pt;font-family: Calibri,sans-serif;margin-bottom: -5px;widows: 1;line-height: 10%;font-weight: 400;">{{ $vendor->vendor_name ?? ' ' }} </p>
                        <p style="font-size:5pt;font-family: Calibri,sans-serif;margin-top: 0;widows: 1;line-height: 180%;font-weight: 400;"><strong style="font-weight: bolder;">Ref No: TE-{{ $vendor->vendor_code }}-{{ preg_replace('/[^0-9]/', '', $rfq->refrence_no ?? '') }} </strong></p><br/>
                                ...
                                <tbody style="font-family: Calibri, sans-serif;">
                                    ...
                                    @foreach ($line_items as $items)
                                        ...
                                        @endif
                                            ...
                                            <td style="font-weight: 400; padding-top: 2px; font-family: Calibri, sans-serif; vertical-align:top;" align="center"><b> {{number_format($items->unit_cost, 2) ?? 0}}</b> </td>

                                            <td style="font-weight: 400; padding-top: 2px; font-family: Calibri, sans-serif; vertical-align:top;" align="center"><b> {{ number_format($items->total_cost, 2) }} </b></td>
                                            @php 
                                    ...
                                    <tr style="font-family: Calibri, sans-serif; margin-bottom:0px;">
                                        ...
                                        <td colspan="3" style="background-color:white; font-family: Calibri, sans-serif; margin-left: 96px;" align="left">
                                            <p style="border-bottom: solid; border-bottom-color: #000000; border-top: solid; border-width:1px !important; white-space:nowrap !important;
                                                ...
                                                <strong> Sub total &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <span style="text-align: right;"> {{ number_format(array_sum($wej),2 )  }} </span></strong>
                                            </p>
