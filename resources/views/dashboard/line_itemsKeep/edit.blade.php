                                                    ...
                                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control" name="unit_margin" id="unit_margin" value="{{ $unitMargin ?? ''}}" placeholder="Enter Unit Margin" type="number" aria-describedby="basic-addon3" readonly>
                                                            </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($line_item as $items)
                                                            <tr>
                                                                ...
                                                                <td style="text-align: right"> {{number_format($items->unit_cost + $unitMargin, 2) ?? 0}} </td>
