...
@section('content')
    <div class="main-container">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">Dashboard </a></li><li class="breadcrumb-item"><a href="{{ route('company.create') }}">Add Company</a></li>
                <li class="breadcrumb-item active"><a href="{{ route('company.index') }}">View Companies</a></li>
                @if (Gate::allows('SuperAdmin', auth()->user()))
                    {{--  <a class="breadcrumb-item"><a href="{{ route('company.restore') }}">Bin</a></a>  --}}
                @endif
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-header">
                                <div class="card-title">Please fill the below for to add company details </div>
                            </div>
                            <form action="{{ route('company.save') }}" class="" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="row gutters">
                                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                                            <label for="fullName">Company Logo</label><div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="image"><i class="icon-image" style="color:#28a745"></i></span>
                                                </div>
                                                <div class="custom-file">
                                                    <input type="file" class="form-control" id="image" name="company_logo" required value="{{ old('company_logo') }}" aria-describedby="inputGroupFileAddon01">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                                            <label for="signature">Company Signature</label><div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="image"><i class="icon-image" style="color:#28a745"></i></span>
                                                </div>
                                                <div class="custom-file">
                                                    <input type="file" class="form-control" id="" name="signature" required value="{{ old('signature') }}" aria-describedby="inputGroupFileAddon01">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                                            <label for="company_name">Company Name</label><div class="input-group">
                                                ...
                                                <input type="text" class="form-control" required id="company_name" name="company_name" value="{{ old('company_name') }}" placeholder="Enter company name"
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                                            <label for="company_code">Company Code</label><div class="input-group">
                                                ...
                                                <input type="text" class="form-control" required id="company_code" name="company_code" value="{{ old('company_code') }}" placeholder="Enter company code"
                                                aria-describedby="basic-addon6">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                                            <label for="email">Login Email</label><div class="input-group">
                                                ...
                                                <input type="email" class="form-control" id="email" name="email" value="{{ old('email') }}" required placeholder="Enter login email"
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                                            <label for="phone">Phone</label><div class="input-group">
                                                ...
                                                <input type="number" class="form-control" id="phone" name="phone" value="{{ old('phone') }}" required placeholder="Enter phone number"
                                                aria-describedby="basic-addon6">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                        <div class="form-group">
                                            <label for="webadd">Website</label><div class="input-group">
                                                ...
                                                <input type="text" class="form-control" required id="webadd" value="{{ old('webadd') }}" name="webadd" placeholder="Enter website"
                                                aria-describedby="basic-addon6">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                        <div class="form-group">
                                            <label for="contact">Contact Name</label><div class="input-group">
                                                ...
                                                <input type="text" class="form-control" required id="contact" value="{{ old('contact') }}" name="contact" placeholder="Enter Contact Name"
                                                aria-describedby="basic-addon6">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                        <div class="form-group">
                                            <label for="counTry">Contact Phone</label><div class="input-group">
                                                ...
                                                <input type="text" class="form-control" required id="counTry" value="{{ old('contact_phone') }}" name="contact_phone" placeholder="Enter Contact Phone"
                                                aria-describedby="basic-addon6">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                        <div class="form-group">
                                            <label for="sTate">Contact Email</label><div class="input-group">
                                                ...
                                                <input type="text" class="form-control" required id="sTate" value="{{ old('contact_email') }}" name="contact_email" placeholder="Enter Contact Email"
                                                aria-describedby="basic-addon6">
                                            </div>
                                    ...
                                    {{-- <div class="col-xl-3 col-lg-3 col-md-4 col-sm-3 col-12">
                                        <div class="form-group">
                                            <label for="expDate">LGA</label><div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="expDate" value="{{ old('lgaId') }}" name="lgaId" required placeholder="Enter LGA"
                                                aria-describedby="basic-addon6">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-3 col-12">
                                        <div class="form-group">
                                            <label for="cardNum">Company Description</label><div class="input-group">
                                                ...
                                                <textarea class="form-control" id="cardNum" name="company_description" required placeholder="Enter Company Description">{{ old('company_description') }}</textarea>
                                            </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-4 col-sm-3 col-12">
                                        <div class="form-group">
                                            <label for="nameOnCard">Address</label>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-6 col-sm-6 col-12" align="right">
                                        <div class="form-group">
                                            <button class="btn btn-primary" type="submit" title="Click the button to add company details">Add Company Details</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
