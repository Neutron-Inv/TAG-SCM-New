    ...
    <div class="main-container">
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('rfq.approve',$refrence_no) }}"> Approve Breakdown</a></li>
                ...
                <li class="breadcrumb-item">Approve Breakdown</li>
            </ol>
        ...
        <div class="content-wrapper">
            <div class="row gutters">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('rfq.approveQuote') }}" class="" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row gutters">
                                    ...
                                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                                        ...
                                        <div class="form-group">
                                            <label for="net_percentage">Note for Approval:</label>
