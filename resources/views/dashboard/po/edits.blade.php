                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('po.update',$details->po_id) }}" class="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row gutters">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label for="frieght_charges">Timely Delivery</label><div class="input-group">
                                                <div class="input-group-prepend">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                value="{{ number_format($tq) ?? '0'}}" placeholder="Supplier QUote USD" 
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label for="payment_terms">Payment Terms</label><div class="input-group">
                                                ...
                                                value="{{$details->payment_terms ?? ""}}" placeholder="Payment Terms">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label for="delivery">Delivery</label><div class="input-group">
                                                <div class="input-group-prepend">
                                                ...
                                                maxlength="" value="{{ $details->delivery ?? ''}}" required placeholder="Enter Delivery" type="text"
                                                aria-describedby="basic-addon3" >
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label for="total_packaged_weight">Total Package Weight</label><div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon3"><i class="icon-sound-mix" style="color:#28a745"></i></span>
                                                </div>
                                                <input class="form-control" name="total_packaged_weight" id="total_packaged_weight"
                                                maxlength="11" value="{{ $details->total_packaged_weight ?? '0'}}" required placeholder="Enter Total Weight" type="text"
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            <label for="estimated_packaged_dimensions">Estimated Packaged Dimensions </label><div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon3"><i class="icon-flash" style="color:#28a745"></i></span>
                                                </div>
                                ...
                                <div class="row gutters">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="card m-0">
                                            ...
                                            <textarea class="summernote1" name="technical_note" placeholder="Please enter technical note (if any)." style="">{!! $details->technical_notes !!}</textarea>
