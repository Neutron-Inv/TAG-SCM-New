    ...
    <div class="main-container">
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('warehouse.inventory',$warehouse_id) }}">{{  $rest->name ?? ''  }} Inventories</a></li>
                <li class="breadcrumb-item active"><a href="{{ route('warehouse.users',$warehouse_id) }}">{{ $rest->name ?? ' Inventory ' }} Users</a></li>
                <li class="breadcrumb-item"><a href="{{ route('warehouse.index') }}">All Warehouse</a></li>
                                        ...
                                        @foreach ($inven as $inventories)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @endif
                                                    <a href="" title="" class="">
                                                        <i class="icon-list" style="color:red"></i>
                                                    </a>
                                                </td>
                                            </tr><?php $num++; ?>
                                        @endforeach
