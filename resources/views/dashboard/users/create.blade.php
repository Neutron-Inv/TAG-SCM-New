                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-header" align="center">
								<div class="card-title"><b>Please fill the below form to add a new super user </b></div>
							</div>
                            <form action="{{ route('users.save') }}" class="" method="POST">
                                {{ csrf_field() }}
                                ...
                                <div class="row gutters">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-6 col-sm-6 col-12" align="right">
                                        <div class="form-group">
                                            <button class="btn btn-primary " type="submit" title="Click the button to add new super user details">Add A New Super Admin</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
