    ...
    <div class="main-container">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('contact.edit',$conc->contact_id) }}">Edit Client Contact</a></li>
                <li class="breadcrumb-item "><a href="{{ route('client.index') }}"> Clients</a></li>
                @if (auth()->user()->hasRole('SuperAdmin'))
                    <li class="breadcrumb-item"><a href="{{ route('contact.index',$cli->email)}}">View Client Contacts</a></li>

                @else

                @endif
                <li class="breadcrumb-item">Edit a Client Contact</li>
            </ol>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-header">
								<div class="card-title">Please fill the below form to update the contact for {{ $cli->client_name }}. </div>
							</div>
                            <form action="{{ route('contact.update',$conc->contact_id) }}" class="" method="POST">
                                {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control selectpicker" data-live-search="true" required name="state">
                                                    ...
                                                    <option data-tokens="{{ $conc->state ?? ''}}" value="{{ $conc->state ?? old('state')}}">{{ $conc->state ?? old('state') }}</option>
                                                    <option value=""> </option>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="city" required placeholder="Enter City" type="text" value="{{ $conc->city ?? old('city') }}"
                                                aria-describedby="basic-addon1">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control selectpicker" data-live-search="true" required name="country_code">
                                                    ...
                                                    <option data-tokens="{{ $conc->country_code ?? ''}}" value="{{ $conc->country_code ?? old('country_code')}}">{{ $conc->country_code ?? old('country_code')}}</option>
                                                    <option value=""> </option>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            @else
                                <div class="table-container">
                                    <h5 class="table-title">List of all Client Contacts</h5>
