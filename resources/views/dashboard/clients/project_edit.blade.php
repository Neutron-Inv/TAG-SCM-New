                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-header">
								<div class="card-title">Please fill the below form to Edit Project for {{ $client->client_name }} </div>
							</div>
                            <form action="{{ route('project.update',$current_project->id) }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="row gutters">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" name="project_name" id="ProjectName" value="{{ $current_project->project_name }}" required type="text" aria-describedby="basic-addon1">
                                        </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" align="right">
                                    <div class="form-group">
                                        <button class="btn btn-primary" type="submit" title="Click the button to create the client contact">Edit Project</button>
                                    </div>
                                </div>
                            </div>
                        </form>
