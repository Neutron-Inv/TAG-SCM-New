                  ...
                  <div class="card h-100">
                    <div class="card-header d-flex justify-content-between">
                      <div class="card-title m-0 me-2">
                        <h5 class="m-0 me-2">{{$reference_no}} RFQ Details</h5>
                        ...
                        <li class="d-flex mb-4 pb-1 align-items-center">
                          <div class="d-flex w-100 align-items-center gap-2">
                            <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
                              ...
                              <div class="user-progress d-flex align-items-center gap-2">
                                <h6 class="mb-0">{{ $rfq->client->client_name ?? ' ' }}</h6>
                              </div>
                            </div>
                        ...
                        <li class="d-flex mb-4 pb-1 align-items-center">
                          <div class="d-flex w-100 align-items-center gap-2">
                            <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
                              ...
                              <div class="user-progress d-flex align-items-center gap-2">
                                <h6 class="mb-0">{{ $rfq->contact->first_name . ' '. $rfq->contact->last_name ?? ' '}}</h6>
                              </div>
                            </div>
                        ...
                        <li class="d-flex mb-4 pb-1 align-items-center">
                          <div class="d-flex w-100 align-items-center gap-2">
                            <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
                              ...
                              <div class="user-progress d-flex align-items-center gap-2">
                                <h6 class="mb-0">{{ $rfq->vendor->vendor_name }}</h6>
                              </div>
                            </div>
                        ...
                        <li class="d-flex mb-4 pb-1 align-items-center">
                          <div class="d-flex w-100 align-items-center gap-2">
                            <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
                              ...
                              <div class="user-progress d-flex align-items-center gap-2">
                                <h6 class="mb-0">{!! $rfq->description !!}</h6>
                              </div>
                            </div>
...
<div class="col-xl-4 col-md-6 mb-4">
    ...
    <div class="card-header d-flex justify-content-between">
                      <div class="card-title m-0 me-2">
                        <h5 class="m-0 me-2">Breakdown Analysis</h5>
    ...
    <div class="card-header d-flex justify-content-between">
        ...
        {!! $rfq->note !!}
            ...
            <div class="table-container p-3">
                    @if($rfq == null && $po == null)
                    <p class="text-danger" style="font-size: 12pt;"> <strong> Rfq / PO Number does not exist. </strong> </p>
                    @endif

                    @if($rfq != null)
            <!-- Bootstrap Table with Caption -->
              <div class="card">
                <h5 class="card-header">{{$reference_no}} RFQ Details</h5>
