    ...
    <div class="main-container">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('inventory.create') }}">Create Inventory</a></li>
                <li class="breadcrumb-item"><a href="{{ route('inventory.index') }}">View Inventories</a></li>
                <li class="breadcrumb-item">Create new inventory</li>
            </ol>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('inventory.save') }}" class="" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="row gutters">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="approved_by" required placeholder="" type="text" value="{{old('approved_by')}}"
                                                aria-describedby="basic-addon1">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="material_number" required placeholder="" type="text" value="{{old('material_number')}}"
                                                aria-describedby="basic-addon1">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="oem" required placeholder="" type="text" value="{{old('oem')}}"
                                                aria-describedby="basic-addon1">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="oem_number" required placeholder="" type="text" value="{{old('oem_number')}}"
                                                aria-describedby="basic-addon1">
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="storage_location" required placeholder="" type="text" value="{{old('storage_location')}}"
                                                aria-describedby="basic-addon1">
                                            </div>
                                    ...
                                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-12">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="quantity" required placeholder="" type="number" value="{{old('quantity')}}"
                                                aria-describedby="basic-addon1">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <select class="form-control selectpicker" data-live-search="true" required name="material_condition">
                                                    <option value="{{ old('material_condition') }}"> {{ old('material_condition')  ??   '-- Select condition --' }}</option>
                                                    <option value=""> </option>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                aria-describedby="basic-addon1"> {{ old('preservation_required') }} </textarea>
                                            </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                aria-describedby="basic-addon1">{{old('recommended_changes')}} </textarea>
                                            </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" name="short_description" required placeholder="" required aria-describedby="basic-addon1">{{old('short_description')}} </textarea>
                                            </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" name="complete_description" required placeholder="" required aria-describedby="basic-addon1">{{old('complete_description')}} </textarea>
                                            </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-6 col-12">
                                        <div class="form-group">
                                            <button class="btn btn-primary" style="float: right" type="submit" title="Click the button to add industry">Add New Inventory</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
